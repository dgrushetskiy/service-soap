 ...
 * 
 */
@WebServiceClient(name = "Weather", targetNamespace = "http://www.codecentric.de/namespace/weatherservice/", wsdlLocation = "file:/C:/Project/service-soap/src/main/resources/service-api-definition/Weather1.0.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/C:/Project/service-soap/src/main/resources/service-api-definition/Weather1.0.wsdl");
